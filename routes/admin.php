...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
		...
		Route::group(['prefix' => 'course'],function(){
			...
			Route::get('/{id}/delete','Admin\CourseManagementController@deleteCourse')->name('admin.course.delete');
			...
			Route::group(['prefix' => 'chapter'],function(){
				Route::get('/{courseId?}', 'Admin\ChaptersController@index')->name('admin.course.chapters.index');
				Route::get('/create/new', 'Admin\ChaptersController@create')->name('admin.course.chapters.create');
		...
		Route::group(['prefix'  =>   'subject-chapters'], function() {
			...
			Route::get('/chapter/fetch/{id}', 'Admin\SubjectChapterController@ChapterFetch')->name('admin.chapter.fetch');
		});
		
		//question module - questions
		Route::group(['prefix'  =>   'questions'], function() {
			Route::get('/list/{subChapterId?}', 'Admin\QuestionController@index')->name('admin.question.index');
			...
			Route::get('/subchapter/fetch/{id}', 'Admin\QuestionController@SubChapterFetch')->name('admin.subchapter.fetch');
