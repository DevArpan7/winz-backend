    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="{{ route('admin.course.chapters.update',$chapter->id) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="chapter" id="chapter" placeholder="Chapter Name" value="{{(old('chapter')) ? old('chapter') : $chapter->name }}">
