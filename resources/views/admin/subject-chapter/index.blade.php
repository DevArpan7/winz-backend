                    ...
                    <table class="table table-hover custom-data-table-style table-striped" id="">
                        ...
                        <tbody>
                            @foreach($sub_chapters as $key => $sub_chapter)
                                <tr>
                                    <td width="5%">{{$key+1}}</td>
                                    <td>{{$sub_chapter->course->course_name}}</td>
                                    <td>{{$sub_chapter->chapter->name}}</td>
                                    <td>{{$sub_chapter->name}}</td>
                                    <td>{!!$sub_chapter->topics!!}</td>
                                    <td>
                                        <a href="{{route('admin.question.index',$sub_chapter->id)}}">{{count($sub_chapter->question)}}</a>
                                    </td>
