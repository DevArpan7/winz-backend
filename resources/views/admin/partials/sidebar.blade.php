    ...
    <ul class="app-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li style="padding-left: 20px;">
                    <a class="treeview-item {{ sidebar_open(['admin.course.chapters.*', 'admin.subject.chapter.*']) }}" href="{{ route('admin.course.chapters.index') }}">Chapters</a>
                </li>
                 <li style="padding-left: 20px;">
                    <a class="treeview-item {{ sidebar_open(['admin.course.sub_chapters.*', 'admin.subject.chapter.*']) }}" href="{{ route('admin.subject.chapter.index') }}">Sub Chapters</a>
                </li>
                <li style="padding-left: 20px;">
