                ...
                <form action="{{ route('admin.course.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        {{-- <div class="form-group">
                            <label class="control-label" for="created_by"> Teacher <span class="m-l-5 text-danger"> *</span></label>
                            <select class="form-control @error('created_by') is-invalid @enderror" name="created_by" id="created_by">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" placeholder="Course Price" value="{{(old('price'))}}">
